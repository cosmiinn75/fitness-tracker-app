...
class MainPage extends StatefulWidget {
   MainPage({super.key, required this.activeWorkoutController, required this.exerciseDefinitionController});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // PAGE CONTENT
            Expanded(
              child: MainPageBody(activeWorkoutController : widget.activeWorkoutController, exerciseDefinitionController: widget.exerciseDefinitionController,),
            ),
          ],
        ),
      ),
